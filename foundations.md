...
{octicon}`thumbsup;1em;caption-text` **The Electronic Frontier Foundation (EFF)**
^^^
...
:::{grid-item-card}
:link: https://edri.org/ 
{octicon}`briefcase;1em;caption-text` **EDRi**
^^^
...
{octicon}`checklist;1em;caption-text` **Science & Design**
^^^
...
{octicon}`project;1em;caption-text` **Privacy International**
^^^
...
{octicon}`heart;1em;caption-text` **Privacy Rights**
^^^
...
:::{grid-item-card}
:link: https://cdt.org/ 
{octicon}`megaphone;1em;caption-text` **CDT**
^^^
...
:::{grid-item-card}
:link: https://epic.org/ 
{octicon}`telescope;1em;caption-text` **EPIC**
^^^
...
{octicon}`telescope;1em;caption-text` **Access Now**
^^^
...
{octicon}`bookmark;1em;caption-text` **Center for Digital Democracy**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Figth for the Future**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Internet Freedom Foundation**
^^^
