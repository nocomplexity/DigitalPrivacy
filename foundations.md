...
{octicon}`hubot;1em;caption-text` **The Electronic Frontier Foundation (EFF)**
^^^
...
:::{grid-item-card}
:link: https://optf.ngo/ 
{octicon}`heart;1em;caption-text` **OPTF**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Open Rights Group**
^^^
...
{octicon}`package;1em;caption-text` **Science & Design**
^^^
...
{octicon}`tag;1em;caption-text` **Privacy International**
^^^
...
{octicon}`bookmark;1em;caption-text` **Privacy Rights**
^^^
...
{octicon}`briefcase;1em;caption-text` **Privacy First**
^^^
...
:::{grid-item-card}
:link: https://cdt.org/ 
{octicon}`bookmark;1em;caption-text` **CDT**
^^^
...
:::{grid-item-card}
:link: https://epic.org/ 
{octicon}`file;1em;caption-text` **EPIC**
^^^
...
{octicon}`book;1em;caption-text` **Access Now**
^^^
...
{octicon}`check-circle;1em;caption-text` **Center for Digital Democracy**
^^^
...
{octicon}`stack;1em;caption-text` **Figth for the Future**
^^^
...
{octicon}`bookmark;1em;caption-text` **Citizen Lab**
^^^
